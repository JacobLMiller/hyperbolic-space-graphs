...
if __name__ == '__main__':
    ...
    parser.add_argument('--convergence', '-c', type=bool, default=False, help='Whether or not to iterate until convergence. If True, max_iter is set to max(200,iterations).')
    ...
    import numpy as np
    from SGD.graph_processing import distance_matrix
    ...
    scale = 10/np.max(d) if scale == 0 else scale
