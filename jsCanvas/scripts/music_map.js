...
(function () {
  ...
  HyperbolicCanvas.scripts['music_map'] = function (canvas) {
    var keysDown = {};
    var keysUp = {};
    ...
    var drawBullets = function () {
      ...
      for (var i in bullets) {
        ...
        path = canvas.pathForHyperbolic(
          HyperbolicCanvas.Circle.givenHyperbolicCenterRadius(bullet, .1),
    ...
    var fn = function () {
      ...
      for (var i in bullets) {
        ...
        if (newBullet.getEuclideanRadius() < .7) {
          newBullets.push(newBullet);
        }else{
          bullet = HyperbolicCanvas.Point.givenEuclideanPolarCoordinates(.7,bullet.getAngle());
